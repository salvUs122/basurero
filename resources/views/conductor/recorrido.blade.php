<x-app-layout>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
                                ...
                                <div class="space-y-4">
                                    ...
                                    <div class="flex items-center">
                                        ...
                                        <div>
                                            ...
                                            <p class="font-medium text-gray-800">{{ $recorridoActivo->ruta->nombre ?? 'Sin ruta' }}</p>
                                    ...
                                    <div class="flex items-center">
                                        ...
                                        <div>
                                            ...
                                            <p class="font-medium text-gray-800">{{ $recorridoActivo->camion->placa ?? 'N/A' }}</p>
                                    ...
                                    <div class="flex items-center">
                                        ...
                                        <div>
                                            ...
                                            <p class="font-medium text-gray-800">{{ $recorridoActivo->fecha_inicio->format('H:i:s') }}</p>
                            ...
                            <div class="space-y-4">
                                <div id="gps-controls">
                                    <button id="btn_gps" 
                                        ...
                                        <span id="btn_gps_text">Iniciar transmisión GPS</span>
                                    </button>
                                </div>
                                
                                <div id="gps-status" class="p-4 bg-gray-50 rounded-lg border border-gray-200">
                            ...
                            <div class="grid grid-cols-2 gap-4">
                                <div class="bg-blue-50 p-4 rounded-lg text-center border border-blue-100">
                                    ...
                                    <div class="mt-2">
                                        ...
                                        <p class="text-xl font-semibold text-gray-800" id="puntos-contador">0</p>
                                    </div>
                                </div>
                                ...
                                <div class="bg-green-50 p-4 rounded-lg text-center border border-green-100">
                                    ...
                                    <div class="mt-2">
                                        ...
                                        <p class="text-xs font-medium text-gray-800" id="ultima-ubicacion">-</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="lg:col-span-2">
                    <div class="bg-white rounded-xl shadow-lg p-6 h-full border border-gray-200">
                        ...
                        <div id="map" class="w-full h-[550px] rounded-lg border border-gray-300"></div>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            // Cargar ruta planificada para el conductor (RUTA AZUL)
                    ...
                    try {
                        ...
                        if (rutaGeojson) {
                            ...
                            if (coords.length > 0) {
                                ...
                                L.marker(inicio, {
                                    icon: L.divIcon({
                                        html: '<div style="background: #10b981; color: white; border-radius: 50%; width: 24px; height: 24px; display: flex; align-items: center; justify-content: center; border: 2px solid white;"><i class="fas fa-play text-xs"></i></div>',
                                        iconSize: [24, 24]
                                    })
                                ...
                                L.marker(fin, {
                                    icon: L.divIcon({
                                        html: '<div style="background: #ef4444; color: white; border-radius: 50%; width: 24px; height: 24px; display: flex; align-items: center; justify-content: center; border: 2px solid white;"><i class="fas fa-flag-checkered text-xs"></i></div>',
                                        iconSize: [24, 24]
                                    })
                            ...
                            // Crear capa para el recorrido real (será rojo)
            ...
            // Mostrar ubicación del conductor CON RUTA AZUL
            function mostrarUbicacionConductor(pos) {
                ...
                if (!markerConductor) {
                    markerConductor = L.marker([lat, lng], {
                        icon: L.divIcon({
                            html: '<div style="background: #8b5cf6; color: white; border-radius: 50%; width: 32px; height: 32px; display: flex; align-items: center; justify-content: center; border: 2px solid white; box-shadow: 0 2px 6px rgba(0,0,0,0.3);"><i class="fas fa-truck text-sm"></i></div>',
                            iconSize: [32, 32],
            ...
            function cicloGPS() {
                ...
                gpsIndicator.className = 'w-3 h-3 bg-yellow-500 rounded-full mr-2';

                navigator.geolocation.getCurrentPosition(
                    async (pos) => {
                        // Mostrar en mapa (con ruta azul)
                        ...
                        if (success) {
                            ...
                            gpsIndicator.className = 'w-3 h-3 bg-green-500 rounded-full mr-2';
                            mapStatus.textContent = 'GPS activo - ' + new Date().toLocaleTimeString();
                        }
                    },
                    (err) => {
            ...
            btnGps.addEventListener('click', function() {
                if (timer) {
                    ...
                    clearInterval(timer);
                    timer = null;
                    btnGpsText.textContent = 'Iniciar transmisión GPS';
                    ...
                    btnGpsText.textContent = 'Detener transmisión GPS';
